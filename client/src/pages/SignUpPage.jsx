        ...
        >
          <div className="text-center mb-10">
            ...
            <h1 className="text-3xl sm:text-4xl font-light tracking-tight">
              Join <span className="text-athena-purple italic">Athena.</span>
            </h1>
          </div>
          ...
          <p className="text-center mt-8 text-athena-offwhite/30 text-sm">
            ...
            <Link to="/login" className="text-athena-purple hover:underline font-mono text-xs uppercase tracking-wider">
              Log In
            </Link>
          </p>
        </motion.div>
